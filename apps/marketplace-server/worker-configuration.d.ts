/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: d835fff8451bb395adbf4ce8fca1dc17)
// Runtime types generated with workerd@1.20260611.1 2026-06-13 
interface __BaseEnv_CloudflareBindings {
	PLUGIN_BUCKET: R2Bucket;
	DB: D1Database;
	MARKETPLACE_NAME: "Recall Plugin Registry";
	MARKETPLACE_DESCRIPTION: "Cloudflare-hosted registry for Recall plugins.";
